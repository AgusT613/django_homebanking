...
SECRET_KEY = "django-insecure-=674yc@s)1z-m7do)n&jv2e6-94_z5*pebbw%t4rns1t9eoxvu"
...
# Raiz de los templates globales
TEMPLATES_DIR = os.path.join(BASE_DIR, "homebanking/templates/")
...
STATIC_URL = "static/"
# Raiz de los archivos estaticos globales
